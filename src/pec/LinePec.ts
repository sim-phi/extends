import type { JudgeLineEventPGS, JudgeLinePGS, NotePGS, SpeedEventPGS } from '../format';
...
export class LinePec {
  ...
  public format(): JudgeLinePGS {
    ...
    const sortFn2 = (a: LineEventPec, b: LineEventPec) => a.startTime - b.startTime + (a.endTime - b.endTime);
    // 不单独判断以避免误差
    const result = {
      formatVersion: 3,
      offset: 0,
